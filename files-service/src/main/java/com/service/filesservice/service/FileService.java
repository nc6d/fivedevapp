...
public class FileService {
    ...
    @Autowired
    public FileService(GridFsTemplate gridFsTemplate, GridFsOperations fsOperations) {
    ...
    public LoadFile downloadFile(String id) throws IOException {
        ...
        if (gridFSFile != null && gridFSFile.getMetadata() != null) {
            ...
            loadFile.setFile(IOUtils.toByteArray(fsOperations.getResource(gridFSFile).getInputStream()));
        }
